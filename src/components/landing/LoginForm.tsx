    ...
    <div className="w-full max-w-sm bg-white/80 backdrop-blur-md p-8 rounded-[32px] border border-white/50 shadow-xl">
      ...
      <div className="mt-6 flex gap-3">
        <button
          ...
          className="flex-1 h-10 rounded-xl bg-gray-50 text-gray-600 text-xs font-bold hover:bg-gray-100 transition-colors"
        >
          멘티 체험하기
        </button>
        <button
          ...
          className="flex-1 h-10 rounded-xl bg-indigo-50 text-indigo-600 text-xs font-bold hover:bg-indigo-100 transition-colors"
        >
          멘토 체험하기
        </button>
      </div>
